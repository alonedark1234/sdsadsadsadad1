...
if (menü.customId === "hepsikur") {
        ...
        client.api.channels(message.channel.id).messages.post({
            data: {
                "content": `<a:dp_sag_ok:1143529154906706021> **Burç Rol :**`,
                "components": [{
                    "type": 1, "components": [{
        ...
        client.api.channels(message.channel.id).messages.post({
            data: {
                "content": `<a:dp_sag_ok:1143529154906706021> **İlişki Rol :**`,
                "components": [{
                    "type": 1, "components": [{
        ...
        client.api.channels(message.channel.id).messages.post({
            data: {
                "content": `<a:dp_sag_ok:1143529154906706021> **Oyun Rol :**`,
                "components": [{
                    "type": 1, "components": [{
                        "type": 3, "custom_id": "oyun", "options": [
                            ...
                            { "label": "Conter Strike", "value": "csgo", "emoji": { "name": "🎯" }, },
                            { "label": "Rol İstemiyorum", "value": "rolsil", "emoji": { "name": "🗑️" }, }
        ...
        client.api.channels(message.channel.id).messages.post({
            data: {
                "content": `<a:dp_sag_ok:1143529154906706021> **Renk Rol :**`,
                "components": [{
                    "type": 1, "components": [{
        ...
        client.api.channels(message.channel.id).messages.post({
            data: {
                "content": `<a:dp_sag_ok:1143529154906706021> **Takım Rol :**`,
                "components": [{
                    "type": 1, "components": [{
