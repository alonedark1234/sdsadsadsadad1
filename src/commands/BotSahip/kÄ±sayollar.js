...
module.exports = {
  conf: {
    ...
    run: async (client, message, args, prefix) => {
     ...
     await message.channel.send({ content : `<a:bit:1143530581771169832> \`${message.guild.name}\`, bot komutlarını incelemek için aşağıdaki menüyü kullan!`, components: [kısayollar] });
