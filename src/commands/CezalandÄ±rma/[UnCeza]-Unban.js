...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    .setColor("#2f3136")
    .setDescription(`
<a:Sivra_yildiz12:1130822466667815023> Banı Kaldıran Yetkili: ${message.author} \`${message.author.id}\`

${miniicon} Banı Kaldıran Üye: \`(${ban.user.username.replace(/\`/g, "")} - ${ban.user.id})\`
