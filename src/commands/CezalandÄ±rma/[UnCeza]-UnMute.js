...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    .setLabel("Chat Mute")
    .setStyle("SECONDARY")
    .setEmoji("1143528008779571271");

    let vmute = new MessageButton()
    .setCustomId("vmute")
    .setLabel("Voice Mute")
    .setStyle("SECONDARY")
    .setEmoji("1143528760944103546");
  ...
  collector.on("collect", async (button) => {
    ...
    if (button.customId === "mute") {
      ...
      const log = embed
        ...
        .setColor("#2f3136")
        .setDescription(`
<a:Sivra_yildiz12:1130822466667815023> ${member.toString()} Adlı Kişinin Chat Mutesi Kaldırıldı
...
${miniicon} Mute Kaldıran Kişi : ${message.author} (\`${message.author.id}\`)`)
    ...
    if (button.customId === "vmute") {
      ...
      const log = embed
        ...
        .setColor("#2f3136")
.setDescription(`
<a:Sivra_yildiz12:1130822466667815023> ${member.toString()} Adlı Kişinin Ses Mutesi Kaldırıldı
