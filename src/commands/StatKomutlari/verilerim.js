...
module.exports = {
  ...
  run: async (client, message, args, embed, prefix) => {
    ...
    embed.setColor("RANDOM").setDescription(`${member.toString()}'n verileri aşağıda verilmiştir.`)
      .addFields(
        {
          name: "<a:bit:1143530581771169832> **Kullanıcı Bilgileri**", value: `
\`\`\`diff
• Kullanıcı : ${member.user.username}
• Kullanıcı ID : ${message.author.id}
\`\`\`
<:Sivra_voice:1130822137691766924> **Ses Bilgileri:**
\`\`\`diff
...
\`\`\`
<a:Sivra_mesaj2:1130822283779379282> **Metin Bilgileri:**
\`\`\`diff
- Toplam Mesaj: ${messageData ? messageData.topStat : 0} 
\`\`\`
<a:dp_sag_ok:1143529154906706021> **İnvite Bilgileri:**(\`\`${total}\`\`)
\`\`\`diff
...
\`\`\`
<a:dp_sag_ok:1143529154906706021> **Kayıt Bilgileri:**(\`\`${data ? data.top : 0}\`\`)
\`\`\`diff
