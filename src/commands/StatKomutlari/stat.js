    ...
    const category = async (parentsArray) => {
      ...
      .addComponents(
          new MessageSelectMenu()
              ...
              .addOptions([
                  { label: '🎧 Genel Sıralama', description: `${message.guild.name} sunucusunun Top20 istatistik sıralaması`, value: 'stat1' },
                  { label: '🎧 Ses İstatistik Detay', description: 'Ses istatistiklerinin detaylı bilgilerini görüntülemektedir', value: 'stat2' },
                  { label: '📝 Mesaj İstatistik Detay', description: 'Mesaj istatistiklerinin detaylı bilgilerini görüntülemektedir', value: 'stat3' },
                  { label: '👥 Kullanıcı Bilgi', description: `${message.guild.name} sunucusunun Top20 istatistik sıralaması`, value: 'stat4' },
...
.addFields(
{ name: `<a:bit:1143530581771169832> __**Toplam Ses**__`,  value: `\`\`\`cs\n${moment.duration(voiceData ? voiceData.topStat : 0).format("H [saat], m [dakika]")}\n\`\`\``, inline: true },
{ name: `<a:bit:1143530581771169832> __**Toplam Mesaj**__`,  value: `\`\`\`cs\n${messageData ? messageData.topStat : 0} mesaj\n\`\`\``, inline: true },
{ name: `<a:bit:1143530581771169832> __**Toplam Davet**__`,  value: `\`\`\`cs\n${inviterData ? `${total} regular`: "Veri bulunmuyor."} \n\`\`\``, inline: true },
)      
.addField(`
...
.addFields(
{ name: `<a:bit:1143530581771169832> __**Toplam Ses**__`,  value: `\`\`\`cs\n${moment.duration(voiceData ? voiceData.topStat : 0).format("H [saat], m [dakika]")}\n\`\`\``, inline: true },
{ name: `<a:bit:1143530581771169832> __**Haftalık Ses**__`,  value: `\`\`\`cs\n${voiceWeekly}\n\`\`\``, inline: true },
{ name: `<a:bit:1143530581771169832> __**Günlük Ses**__`,  value: `\`\`\`cs\n${voiceDaily}\n\`\`\``, inline: true },
)
...
.addFields(
{ name: `<a:bit:1143530581771169832> __**Toplam Mesaj**__`,  value: `\`\`\`cs\n${messageData ? messageData.topStat : 0} mesaj\n\`\`\``, inline: true },
{ name: `<a:bit:1143530581771169832> __**Haftalık Mesaj**__`,  value: `\`\`\`cs\n${Number(messageWeekly).toLocaleString()} mesaj\n\`\`\``, inline: true },
{ name: `<a:bit:1143530581771169832> __**Günlük Mesaj**__`,  value: `\`\`\`cs\n${Number(messageDaily).toLocaleString()} mesaj\n\`\`\``, inline: true },
)
