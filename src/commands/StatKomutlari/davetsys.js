...
<a:Sivra_yildiz12:1130822466667815023> Merhaba ${member.toString()} Davet Statların Aşağıda Listelenmiştir.
...
.setDescription(`
<a:Sivra_yildiz12:1130822466667815023> ${member.toString()} Kullanıcısının Yaptığı Davetler Aşağıda Belirtilmiştir.`)

.addFields(
{ name: "<a:dp_sag_ok:1143529154906706021> __**Toplam Davet**__",  value: `
\`\`\`fix
${inviterData ? inviterData.total : 0} Davet
\`\`\`
`, inline: true },
{ name: "<a:dp_sag_ok:1143529154906706021> __**Fake Davet**__",  value: `
\`\`\`fix
${inviterData ? inviterData.fake : 0} Fake Davet
\`\`\`
`, inline: true },
{ name:"<a:dp_sag_ok:1143529154906706021> __**Bonus Davet**__",  value: `
\`\`\`fix
...
embeds.addField(`
<a:Sivra_yildiz12:1130822466667815023> **Davet İstatistiği**`, `
