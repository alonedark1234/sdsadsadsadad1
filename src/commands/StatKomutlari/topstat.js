...
.setDescription(`
<a:bit:1143530581771169832> Aşağıda **${message.guild.name}** sunucusunun en iyileri sıralanmaktadır.
...
<a:dp_sag_ok:1143529154906706021> En iyiler \`${moment(Date.now()).format("LLL")}\` tarihinde otomatik olarak güncellenmiştir.`)
.setAuthor({ name: message.guild.name, iconURL: message.guild.iconURL({ dynamic: true, size: 2048 })})
.setThumbnail(message.guild.iconURL({ dynamic: true, size: 2048 }));
...
const embeds = new MessageEmbed()
.setDescription(`
<a:bit:1143530581771169832> Aşağıda **${message.guild.name}** sunucusunun genel sohbet( \`ses\` ) sıralaması listelenmektedir.

${list.length > 0 ? list : "Veri Bulunmuyor."}

<a:dp_sag_ok:1143529154906706021> Genel sohbet( \`ses\` ) sıralaması \`${moment(Date.now()).format("LLL")}\` tarihinde otomatik olarak güncellenmiştir.`)
.setAuthor({ name: message.guild.name, iconURL: message.guild.iconURL({ dynamic: true, size: 2048 })})
.setThumbnail(message.guild.iconURL({ dynamic: true, size: 2048 }));
...
const embeds = new MessageEmbed()
.setDescription(`
<a:bit:1143530581771169832> Aşağıda **${message.guild.name}** sunucusunun bu haftanın sohbet( \`ses\` ) sıralaması listelenmektedir.
  
${list.length > 0 ? list : "Veri Bulunmuyor."}
  
<a:dp_sag_ok:1143529154906706021> Bu haftanın sohbet( \`ses\` ) sıralaması \`${moment(Date.now()).format("LLL")}\` tarihinde otomatik olarak güncellenmiştir.`)
.setAuthor({ name: message.guild.name, iconURL: message.guild.iconURL({ dynamic: true, size: 2048 })})
.setThumbnail(message.guild.iconURL({ dynamic: true, size: 2048 }));
...
const embeds = new MessageEmbed()
.setDescription(`
<a:bit:1143530581771169832> Aşağıda **${message.guild.name}** sunucusunun genel sohbet( \`mesaj\` ) sıralaması listelenmektedir.
    
${list.length > 0 ? list : "Veri Bulunmuyor."}
    
<a:dp_sag_ok:1143529154906706021> Genel sohbet( \`mesaj\` ) sıralaması \`${moment(Date.now()).format("LLL")}\` tarihinde otomatik olarak güncellenmiştir.`)
.setAuthor({ name: message.guild.name, iconURL: message.guild.iconURL({ dynamic: true, size: 2048 })})
.setThumbnail(message.guild.iconURL({ dynamic: true, size: 2048 }));
...
const embeds = new MessageEmbed()
.setDescription(`
<a:bit:1143530581771169832> Aşağıda **${message.guild.name}** sunucusunun bu haftanın sohbet( \`mesaj\` ) sıralaması listelenmektedir.
      
${list.length > 0 ? list : "Veri Bulunmuyor."}
      
<a:dp_sag_ok:1143529154906706021> Bu haftanın sohbet( \`mesaj\` ) sıralaması \`${moment(Date.now()).format("LLL")}\` tarihinde otomatik olarak güncellenmiştir.`)
.setAuthor({ name: message.guild.name, iconURL: message.guild.iconURL({ dynamic: true, size: 2048 })})
.setThumbnail(message.guild.iconURL({ dynamic: true, size: 2048 }));
...
const embeds = new MessageEmbed()
.setDescription(`
<a:bit:1143530581771169832> Aşağıda **${message.guild.name}** sunucusunun genel yetkili sıralaması listelenmektedir.
        
${list.length > 0 ? list : "Veri Bulunmuyor."}
        
<a:dp_sag_ok:1143529154906706021> Genel Yetkili sıralaması \`${moment(Date.now()).format("LLL")}\` tarihinde otomatik olarak güncellenmiştir.`)
.setAuthor({ name: message.guild.name, iconURL: message.guild.iconURL({ dynamic: true, size: 2048 })})
.setThumbnail(message.guild.iconURL({ dynamic: true, size: 2048 }));
...
const embeds = new MessageEmbed()
.setDescription(`
<a:bit:1143530581771169832> Aşağıda **${message.guild.name}** sunucusunun genel zengin sıralaması listelenmektedir.
                
${list.length > 0 ? list : "Veri Bulunmuyor."}
                
<a:dp_sag_ok:1143529154906706021> Genel Zengin sıralaması \`${moment(Date.now()).format("LLL")}\` tarihinde otomatik olarak güncellenmiştir.`)
.setAuthor({ name: message.guild.name, iconURL: message.guild.iconURL({ dynamic: true, size: 2048 })})
.setThumbnail(message.guild.iconURL({ dynamic: true, size: 2048 }));
...
const embeds = new MessageEmbed()
.setDescription(`
<a:bit:1143530581771169832> Aşağıda **${message.guild.name}** sunucusunun genel davet sıralaması listelenmektedir.
                
${list}
                
<a:dp_sag_ok:1143529154906706021> Genel Davet sıralaması \`${moment(Date.now()).format("LLL")}\` tarihinde otomatik olarak güncellenmiştir.
...
const embeds = new MessageEmbed()
.setDescription(`
<a:bit:1143530581771169832> Aşağıda **${message.guild.name}** sunucusunun genel kayıt sıralaması listelenmektedir.
                    
${list}
                    
<a:dp_sag_ok:1143529154906706021> Genel Kayıt sıralaması \`${moment(Date.now()).format("LLL")}\` tarihinde otomatik olarak güncellenmiştir.
`)
.setAuthor({ name: message.guild.name, iconURL: message.guild.iconURL({ dynamic: true, size: 2048 })})
.setThumbnail(message.guild.iconURL({ dynamic: true, size: 2048 }));
msg.edit({ embeds: [embeds], components : [row] })
