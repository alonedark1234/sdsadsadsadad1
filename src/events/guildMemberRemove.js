...
> <a:dp_sag_ok:1143529154906706021> \`${member.user.tag}\` İsimli Üye <t:${Math.floor(Date.now() / 1000)}> Tarihinde Sunucumuzdan Ayrıldı Ama Kimin Davet Ettiği Bulunamadı.`});
  } else {
    ...
    channel.wsend({ content:`
> <a:dp_sag_ok:1143529154906706021> \`${member.user.tag}\` İsimli Üye <t:${Math.floor(Date.now() / 1000)}> Tarihinde Sunucumuzdan Ayrıldı. **${inviter.tag}** Tarafından Davet Edilmişti. (\`${total} davet\`)`});
